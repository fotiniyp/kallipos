...
◊epigraph["feynman-understand"]

◊include["abs-tools"]

◊section{Το περιβάλλον ανάπτυξης λογισμικού}
...
◊fn{◊figref["grail-flow"]}
◊fn{◊figref["max-language"]}
...
◊fn{◊figref["eclipse-ide"]}
◊fn{◊figref["processing-ide"]}

◊figure["eclipse-ide"]

◊figure["processing-ide"]
...
◊fn{◊figref["visual-basic-form-designer"]}
...
◊figure["visual-basic-form-designer"]

◊figure["windows-mobile"]
...
◊fn{◊cite["reas2007processing, @victor2012learnable"]} 
...
◊fn{◊figref["android-emulator"]}
◊fn{◊figref["geolocation-simulation"]}
...
◊fn{◊cite["ingalls2020evolution"]}

◊figure["pygmalion"]

◊figure["programming-example"]
...
◊section{Συνεργατική κατασκευή και ιδιοκτησία}
...
Η κίνηση του ◊em{φτιάξτο μόνος σου} σίγουρα δεν είναι νέα και δεν αφορά μόνο το υλικό και το λογισμικό, 
...
◊fn{◊figref["xerox-colab"]}
◊fn{◊figref["makerspace"]}
...
◊fn{◊figref["github-contributions"]}
◊fn{◊figref["github-profile"]}

◊figure["github-contributions"]

◊figure["github-profile"]
