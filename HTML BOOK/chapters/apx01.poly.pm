...
◊chapter{Κατασκευή του Βιβλίου}

◊epigraph["kay-art"]

◊section{Τι είναι ένα βιβλίο;}
...
βρίσκουμε για τη φύση του σύγχρονου βιβλίου.
◊fn{◊cite["borsuk2018book"]}
...
◊section{Πώς κατασκευάζουμε ένα βιβλίο;}
...
στο αποθετήριο 
[https://github.com/pibook](https://github.com/pibook)
