...
◊fn{◊figref["macintosh-desktop"]}
◊fn{◊figref["tmux-desktop"]}
...
◊figure["xerox-parc-tab"]

◊figure["tabs-pads-boards"]
...
◊fn{◊cite["hertzfeld2004revolution"]} 
...
◊fn{◊figref["xerox-parc-tab"]}
◊fn{◊figref["tabs-pads-boards"]}
...
αναδύεται μια νέα μορφή προσωπικού συστήματος διάδρασης με την ονομασία ◊em{έξυπνο τηλέφωνο}, 
...
◊fn{◊figref["apple-newton"]}
◊fn{◊figref["iphone-jobs"]}


◊section{Πέρα από τον υπολογισμό}
...
όπως τα ψυχαγωγικά προγράμματα τρίλιζα, λαβύρινθος και Spacewar ή την ◊em{πολύ ακριβή γραφομηχανή}. 
...
◊fn{◊figref["electrocular"]}
◊fn{◊figref["damocles-sword"]}
...
◊section{Συνεργατικό οικοσύστημα διεπαφών}

◊figure["xerox-pad-board"]

◊figure["xerox-liveboard"]

Η συνεργασία μεταξύ των ανθρώπων και μέσω των υπολογιστών είναι ένα διαχρονικό θέμα στα συστήματα διάδρασης.
◊fn{◊figref["xerox-pad-board"]}
◊fn{◊figref["xerox-liveboard"]}
...
◊fn{◊cite["engelbart1988augmented"]} 
