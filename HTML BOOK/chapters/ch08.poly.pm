...
◊epigraph["kay-software"]

◊include["abs-technology"]

◊section{Τεχνολογικά προϊόντα}
...
◊fn{◊cite["computer1993connections"]}
...
◊section{Εξομοίωση και προσομοίωση}

◊figure["paper-simulation"]
...
Δεν είναι τυχαίο ότι ο δημιουργός και νονός της θεωρεί ατυχές το όνομα ◊em{εικονική πραγματικότητα}, 
...
◊fn{◊cite["engelbart1962augmenting @lanier2010you"]} 
...
που η τηλεόραση αρχικά ορίστηκε ως ◊em{ραδιόφωνο με εικόνα}
...
◊fn{◊cite["bardini2000bootstrapping"]} 
...
◊fn{◊figref["nova"]}
◊fn{◊figref["altair-teletype"]}


◊section{Μοντελοποίηση και Αναλογία}

◊figure["digital-desk"]

◊figure["mit-clearboard"]
